...
def run_experiment(input_string,n,tournament_size,iterations,distance_matrix,mutation_point,crossover_type,mutation):
    ...
    log_file = open(f"logs_burma/genetic_algorithm_log.txt_{n}_{iterations}_{tournament_size}.txt", "w")
    ...
    experiment_results.to_csv(f'output_csv_burma/experiment_results_pop_size_{n}_tournament_size_{tournament_size}_iterations_{iterations}_crossover_type_{crossover_type}.csv', index=False)
    print(counter)
