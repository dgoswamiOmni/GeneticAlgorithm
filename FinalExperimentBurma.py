...
def run_experiment(input_string, n, tournament_size, iterations, distance_matrix, mutation_point, crossover_type, mutation_type, mutation):
    ...
    experiment_results.to_csv(f'output_csv_burma/experiment_results_pop_size_{n}_tournament_size_{tournament_size}_iterations_{iterations}_crossover_type_{crossover_type}_mutation_type_{mutation_type}_time_taken{start_time-end_time}.csv', index=False)
